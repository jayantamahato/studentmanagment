...
<div class="content">
    <form action="../backend/addnotice.php" method="post" enctype="multipart/form-data">
        <input type="text" name="title" placeholder="Notice Title" ><br>
        <input type="date" name="pdate" id="publish date" placeholder="publish date"><br>
        <textarea name="topic" id="topic" cols="90" rows="10">
        type notice here...(first clear it)
        </textarea><br>
        <input type="file" name="notice" id="">
        <div class="btn">
