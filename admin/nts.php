...
table{
    ...
    <tr>       
        ...
        <td><a href="../backend/ntsdelete.php?id=<?php echo $fetch['fsid']; ?>" style="color:red">delete</a>
        <a href="ntsedit.php?id=<?php echo $fetch['fsid']; ?>" style="color:orange;padding:2px;">edit</a>       
    </tr>
    <?php
        }
        ?>
